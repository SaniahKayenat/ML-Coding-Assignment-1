"""from-scratch linear regression for A2: Predicting Car Price.

## Task 1 — Implementation

This file holds the model code, based on the `LinearRegression` class from
...
class LinearRegression(object):
    ...
    def fit(self, X_train, y_train):
        ...
        for fold, (train_idx, val_idx) in enumerate(self.cv.split(X_train)):
            ...
            for epoch in range(self.num_epochs):
                ...
                # stop if the loss exploded (e.g. too large lr * momentum)
    ...
    def fit_final(self, X, y):
        """ after CV has picked the settings, train ONE model on the whole training set.
